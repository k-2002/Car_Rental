        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Cancel_booking</li>
            </ol>
          </div>
...
<?php
  ...
  $query= "SELECT name FROM `register` where id='$uemail'";
 ...
 $query= "SELECT * FROM `booking` where `status`='cancel'";
  ...
  $result = mysqli_query($conn,$query);
    ...
    while($row=mysqli_fetch_assoc($result))
    {
                                ...
                                $result1 = mysqli_query($conn,$query1) or die('query errror');
