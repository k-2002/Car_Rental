      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cars Tables</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Cars Tables</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Cars Tables</h6>
                </div>
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                      <tr>
                        ...
                        <th class="border">Brand Name</th>
                        <th class="border">Price/Daya</th>
                        <th class="border">Fuel Type</th>
                        <th class="border">Seats</th>
                        <th class="border">Image1</th>
                        <th class="border">Image2</th>
                        <th class="border">Image3</th>
                        <th class="border">Image4</th>
                        <th class="border">Milage</th>
                        <th class="border">Transmission</th>
                        <th class="border">Luggage</th>
                        <th class="border">Aircondition</th>
                        <th class="border">Audio Input</th>
                        <th class="border">Car Kit</th>
                        <th class="border">Child Seat</th>
                        <th class="border">Bluthooth</th>
                        <th class="border">Music</th>
                        <th class="border">Powerdoorlocks</th>
                        <th class="border">Seats Belt</th>
                        <th class="border">Onboard Computer</th>
                        <th class="border">Remote central locking</th>
                        ...
                        if (mysqli_num_rows($result)>0)
                        {
                            while($row=mysqli_fetch_assoc($result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="border"><?php echo $row['Brand']; ?></td>
                                    <td class="border"><?php echo $row['price_day']; ?></td>
                                    <td class="border"><?php echo $row['fuel_type']; ?></td>
                                    <td class="border"><?php echo $row['seats']; ?></td>
                                    <td class="border">
                                    ...
                                    <td class="border"><?php echo $row['luggage']; ?></td>
                                    ...
                                    <td class="border"><?php echo $row['seat_belt']; ?></td>
                                    <td class="border"><?php echo $row['onboard_computer']; ?></td>
                                    <td class="border"><?php echo $row['remote_lock']; ?></td>
