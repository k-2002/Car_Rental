        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Confirm_booking</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Confirm Booking</h6>
                </div>
...
<?php
 ...
 $query= "SELECT * FROM `booking` where `status`='confirm'";
  ...
  $result = mysqli_query($conn,$query);
    ...
    while($row=mysqli_fetch_assoc($result))
    {
                                ...
                                $result2 = mysqli_query($conn,$query2) or die('query errror');
...
?>   
                                ...
                                <tr>
                                    ...
                                    <td class="border"><?php echo $c_name; ?></td>
